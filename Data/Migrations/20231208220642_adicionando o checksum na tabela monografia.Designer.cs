...
namespace MonografiasIfma.Data.Migrations
{
    ...
    [Migration("20231208220642_adicionando o checksum na tabela monografia")]
    partial class adicionandoochecksumnatabelamonografia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonografiasIfma.Models.Aluno", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MonografiasIfma.Models.Funcionario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MonografiasIfma.Models.Orientador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MonografiasIfma.Models.Monografia", b =>
                {
                    b.HasOne("MonografiasIfma.Models.Aluno", "Aluno")
                        .WithMany("Monografias")
                        .HasForeignKey("AlunoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MonografiasIfma.Models.Orientador", "Orientador")
                        .WithMany("Monografias")
